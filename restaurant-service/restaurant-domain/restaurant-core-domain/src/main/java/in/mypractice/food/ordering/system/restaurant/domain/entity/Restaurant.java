...
public class Restaurant extends AggregateRoot<RestaurantId> {
    ...
    public static final class Builder {
        ...
        public Builder orderDetail(OrderDetails val) {
            orderDetail = val;
            return this;
        }
    ...
    public boolean equals(Object o) {
        ...
        return active == that.active && Objects.equals(orderApproval, that.orderApproval) && Objects.equals(orderDetail, that.orderDetail);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), orderApproval, active, orderDetail);
    }
}